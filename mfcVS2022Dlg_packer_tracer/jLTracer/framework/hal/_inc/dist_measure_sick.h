...
class distSensor_sick:IDistMeasure
{
  /****************************************************
   *	data
   ****************************************************/
...
private:
  ...
  buffer::_que<double> m_QmesureValue{100};
   ...
   ****************************************************/
public:
  distSensor_sick(common::Attribute_t common_data, distSensor_sick::cfg_t& cfg);

  virtual ~distSensor_sick();
