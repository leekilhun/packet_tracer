...
errno_t fastech_motor::update_AxisState()
{
  errno_t ret = 0;

  fastech_motor::cmd_t cmd = (fastech_motor::cmd_t)m_Packet.rx_packet.type;
  comm_t rcv_data = m_Packet;
  byte* p_data = rcv_data.rx_packet.data;
  switch (cmd)
  {
  case fastech_motor::cmd_t::GET_SLAVE_INFO:
    break;
  case fastech_motor::cmd_t::GET_MOTOR_INFO:
    break;
  case fastech_motor::cmd_t::SAVE_ROM_ALL:
    break;
  case fastech_motor::cmd_t::GET_ROM_PARAM:
    break;
  case fastech_motor::cmd_t::SET_RAM_PARAM:
    break;
  case fastech_motor::cmd_t::GET_RAM_PARAM:
    break;
  case fastech_motor::cmd_t::SET_IO_OUT_REG:
    break;
  case fastech_motor::cmd_t::SET_IO_IN_REG:
    break;
  case fastech_motor::cmd_t::GET_IO_IN_REG:
    break;
  case fastech_motor::cmd_t::GET_IO_OUT_REG:
    break;
  case fastech_motor::cmd_t::SET_ASSN_IO_MAP:
    break;
  case fastech_motor::cmd_t::GET_ASSN_IO_MAP:
    break;
  case fastech_motor::cmd_t::READ_IO_MAP:
    break;
  case fastech_motor::cmd_t::TRG_OUT_RUN_A:
    break;
  case fastech_motor::cmd_t::TRG_OUT_STATUS:
    break;
  case fastech_motor::cmd_t::SERVO_ENABLE:
    break;
  case fastech_motor::cmd_t::ALARAM_RESET:
    break;
  case fastech_motor::cmd_t::GET_ALARM_INFO:
    break;
  case fastech_motor::cmd_t::MOVE_STOP:
    break;
  case fastech_motor::cmd_t::MOVE_EMG_STOP:
    break;
  case fastech_motor::cmd_t::MOVE_ORG_SINGLE_AXIS:
    break;
  case fastech_motor::cmd_t::MOVE_ABS_SINGLE_AXIS:
    break;
  case fastech_motor::cmd_t::MOVE_REL_SINGLE_AXIS:
    break;
  case fastech_motor::cmd_t::MOVE_TO_LIMIT:
    break;
  case fastech_motor::cmd_t::MOVE_VELOCITY:
    break;
  case fastech_motor::cmd_t::MOVE_ABS_OVERRIDE:
    break;
  case fastech_motor::cmd_t::MOVE_REL_OVERRIDE:
    break;
  case fastech_motor::cmd_t::MOVE_VELOCITY_OVERRIDE:
    break;
  case fastech_motor::cmd_t::MOVE_ALL_STOP:
    break;
  case fastech_motor::cmd_t::MOVE_ALL_EMG_STOP:
    break;
  case fastech_motor::cmd_t::MOVE_ALL_ORG_STOP:
    break;
  case fastech_motor::cmd_t::MOVE_ALL_ABS_POS:
    break;
  case fastech_motor::cmd_t::MOVE_ALL_REL_POS:
    break;
  case fastech_motor::cmd_t::GET_AXIS_STATUS:
    break;
  case fastech_motor::cmd_t::GET_AXIS_IO_STATUS:
    break;
  case fastech_motor::cmd_t::GET_MOTION_STATUS:
  {
    enum class step_ {
  ...
  break;
  case fastech_motor::cmd_t::GET_ALL_STATUS:
  {
    enum class step_ {
  ...
  break;
  case fastech_motor::cmd_t::CLEAR_POSITION:
    break;
  }
...
uint32_t fastech_motor::SendCommand(cmd_t cmd, uint8_t* p_data, uint8_t length)
{
 ...
 //   return 0;
  ...
  util::crc16_update(&crc, packet[index++]);
  ...
  m_Packet.resp_time = util::millis();
...
void fastech_motor::LoadingParamterData()
{
}

errno_t fastech_motor::Initialize()
{
...
errno_t fastech_motor::MotorOnOff(bool on_off)
{
...
bool fastech_motor::IsMotorOn()
{
  m_AxisState.is_motor_on = m_AxisState.axis_status[FM_STATE_01][REG_BIT(REG_SERVO_ON)];
  return  m_AxisState.is_motor_on;
}

errno_t fastech_motor::WaitDone(uint8_t mode)
{
  return errno_t();
}

bool fastech_motor::IsAxisDone()
{
  return false;
}

errno_t fastech_motor::ClearState()
{
  return errno_t();
}


uint32_t fastech_motor::GetAllState()
{
  //if (m_Cfg.pComm->IsConnected() == false)
  //  return 0;
...
uint32_t fastech_motor::GetMotorState()
{
  //if (m_Cfg.pComm->IsConnected() == false)
  //  return 0;
...
bool fastech_motor::IsOff(uint32_t addr)
{
  return false;
}

errno_t fastech_motor::OutputOn(uint32_t addr)
{
  return errno_t();
}

errno_t fastech_motor::OutputOff(uint32_t addr)
{
  return errno_t();
}

errno_t fastech_motor::OutputToggle(uint32_t addr)
{
  return errno_t();
}
